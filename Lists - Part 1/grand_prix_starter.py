...
# And again the leader of the pack runs into trouble! He's not out of the race, but he's now moved to last place.  
# Remove the first driver in the list, store it in variable, and then add it to the end of the list.
